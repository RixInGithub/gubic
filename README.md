...
## todo
 ...
 1. do the gdt
 2. move mouse and keyboard to some separate driver or something like that
 3. way to disable the g key (for fun)
 4. separate keys which would be generated by holding shift
